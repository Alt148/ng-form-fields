...
@NgModule({
  ...
  declarations: [ FormFieldsComponent, FieldDirective, FormInput, FormSelect, FormButton, FormCheckbox, FormRadio ],
  exports: [ FormFieldsComponent ],
  entryComponents: [ FormInput, FormSelect, FormButton, FormCheckbox, FormRadio ]
})
